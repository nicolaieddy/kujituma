...
-- Fix the get_weekly_dashboard_data RPC to:
-- 1. Return the LATEST planning session (by is_completed DESC, then updated_at DESC)
-- 2. This ensures we get the completed one if it exists
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'progress_post', (
      ...
      -- Prefer completed posts, then most recently updated
