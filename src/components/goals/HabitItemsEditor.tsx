...
export const HabitItemsEditor = ({ 
  ...
  return (
    <div className="space-y-3">
      <Label className="font-medium text-sm">Habit Items</Label>
      <p className="text-xs text-muted-foreground -mt-1">
        Add multiple habits to track for this goal. Each habit can have its own frequency.
      </p>
      ...
      {habitItems.length === 0 && (
        <p className="text-xs text-muted-foreground italic">
          No habits added yet. Add habits above to track them with daily checkboxes.
        </p>
      )}
    </div>
  );
