        ...
        <CollapsibleContent className="pt-3">
          <div className="grid gap-2 sm:grid-cols-2">
            {[
              ...
              { name: "auto_link_orphan_activities", desc: "Auto-link unmatched activities to plan slots (±day tolerance)" },
              { name: "list_training_events", desc: "List injuries, races, milestones" },
              { name: "create_training_event", desc: "Log a key event (supports structured body_parts + issue_category for injuries)" },
              { name: "update_training_event", desc: "Edit an event (supports body_parts + issue_category)" },
             ...
             { name: "update_social_post", desc: "Update post fields (status, platforms, pillars, media_type, media_focus, etc.)" },
             ...
             { name: "log_social_metrics", desc: "Upsert a metrics snapshot for a post on a date" },
              ...
              { name: "get_content_type_trends", desc: "Time-bucketed performance for a media_type/media_focus cohort vs baseline (ER lift, impressions, top posts)" },
