...
interface CheckInQuestionsSettingsProps {
  open: boolean;
...
export const CheckInQuestionsSettings = ({ open, onOpenChange }: CheckInQuestionsSettingsProps) => {
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full sm:max-w-md flex flex-col p-0 gap-0">
        <SheetHeader className="px-6 pt-6 pb-4 border-b border-border">
          <SheetTitle>Customise Check-in Questions</SheetTitle>
          <SheetDescription>
            Add your own prompts to the daily check-in. Built-in mood &amp; energy questions are always shown.
          </SheetDescription>
        </SheetHeader>
